      ...
      <div className="container mx-auto text-center max-w-2xl">
        ...
        >
          <input
            ...
            className="w-full sm:w-2/3 px-4 py-3 rounded-lg text-gray-900 focus:outline-none"
          />
          <button
            type="submit"
            className="px-6 py-3 bg-gray-900 rounded-lg hover:bg-gray-800 transition w-full sm:w-auto"
          >
            Subscribe
          </button>
        </form>
